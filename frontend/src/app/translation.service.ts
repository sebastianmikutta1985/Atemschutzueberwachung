...
const TRANSLATIONS: Record<Lang, TranslationTree> = {
  de: {
    ...
    dashboard: {
      ...
      alarmAckHint: 'Der Alarm wiederholt sich, bis er bestätigt wird.',
      endOperationConfirmTitle: 'Einsatz beenden?',
      endOperationConfirmText: 'Einsatz „{name}“ wirklich beenden? Das kann nicht rückgängig gemacht werden.',
      endOperationConfirmActiveCrews: 'Einsatz „{name}“ wirklich beenden? {count} Trupp(s) sind noch aktiv und werden ebenfalls beendet. Das kann nicht rückgängig gemacht werden.',
      endCrewConfirmTitle: 'Trupp beenden?',
      endCrewConfirmText: 'Trupp „{name}“ wirklich beenden? Die Überwachung dieses Trupps endet damit.',
      pressureCheckDue: 'Druckabfrage fällig ({fraction} der Zeit)',
      pressureCheckDueCrew: '{name}: Druckabfrage fällig ({fraction} der Einsatzzeit).',
      lowestPressure: 'Niedrigster Druck',
      audioBlocked: 'Alarmton ist noch nicht freigegeben – der Browser spielt Töne erst nach einer Berührung ab.',
      audioEnable: 'Ton aktivieren',
      clockAhead: 'Die Uhr dieses Geräts geht {minutes} min vor; angezeigt wird die Serverzeit.',
      clockCorrectedShort: 'Geräteuhr korrigiert',
      clockBehind: 'Die Uhr dieses Geräts geht {minutes} min nach; angezeigt wird die Serverzeit.',
    ...
    manufacturer: {
      ...
      resetPinTitle: '{role}-PIN neu setzen',
      roleUser: 'Benutzer',
      resetPinHint: 'Alle bestehenden Anmeldungen dieser Rolle werden beendet.',
      newPin: 'Neue PIN (mind. 6 Zeichen)',
      blockConfirmTitle: 'Organisation sperren?',
      blockConfirmText: '„{name}“ wirklich sperren? Alle Geräte der Organisation werden sofort abgemeldet – auch während eines laufenden Einsatzes.'
    },
    legal: {
      eyebrow: 'Rechtliches',
      imprint: 'Impressum',
  ...
  en: {
    ...
    dashboard: {
      ...
      alarmAckHint: 'The alarm repeats until it is acknowledged.',
      endOperationConfirmTitle: 'End incident?',
      endOperationConfirmText: 'Really end incident "{name}"? This cannot be undone.',
      endOperationConfirmActiveCrews: 'Really end incident "{name}"? {count} crew(s) are still active and will be finished as well. This cannot be undone.',
      endCrewConfirmTitle: 'Finish crew?',
      endCrewConfirmText: 'Really finish crew "{name}"? Monitoring for this crew stops.',
      pressureCheckDue: 'Pressure check due ({fraction} of time)',
      pressureCheckDueCrew: '{name}: pressure check due ({fraction} of operating time).',
      lowestPressure: 'Lowest pressure',
      audioBlocked: 'Alarm sound is not enabled yet – the browser only plays sounds after a tap.',
      audioEnable: 'Enable sound',
      clockAhead: 'This device clock is {minutes} min fast; server time is shown.',
      clockCorrectedShort: 'Device clock corrected',
      clockBehind: 'This device clock is {minutes} min slow; server time is shown.',
    ...
    manufacturer: {
      ...
      resetPinTitle: 'Set new {role} PIN',
      roleUser: 'User',
      resetPinHint: 'All existing sign-ins for this role will be ended.',
      newPin: 'New PIN (min. 6 characters)',
      blockConfirmTitle: 'Block organization?',
      blockConfirmText: 'Really block "{name}"? All devices of the organization are signed out immediately – even during an ongoing incident.'
    },
    legal: {
      eyebrow: 'Legal',
      imprint: 'Imprint',
